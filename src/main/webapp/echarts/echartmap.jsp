...
<div class="navbar navbar-fixed-top">
	...
	<script type="text/javascript">
		...
		var xhrurl = 'http://echarts.baidu.com/doc/example/geoJson/china-main-city/110100.json';
		...
		require(
			...
			cityMap = {
				...
				for (var city in cityMap) {
				    mapType.push(city);
				    // 自定义扩展图表类型
				    console.log("1：coming in..."+city);
				    mapGeoData.params[city] = {
				        getGeoJson: (function (c) {
				            var geoJsonName = cityMap[c];
				            console.log("geoJsonName："+geoJsonName);
				            return function (callback) {
				                $.getJSON('common_loadJson.action?jsonUrl=http://echarts.baidu.com/doc/example/geoJson/china-main-city/' + geoJsonName + '.json', callback);
				            }
				        })(city)
				    }
				}
